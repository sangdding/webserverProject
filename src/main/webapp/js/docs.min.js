!function (e, t) {
    ...
    return function (e) {
        ...
        this.options = e || {}, this.elements = [], t(this.options), this.isTouchDevice = function () {
            ...
            if (t(this.options), "touch" === (A = this.options.visible) && (A = this.isTouchDevice() ? "always" : "hover"), e || (e = "h2, h3, h4, h5, h6"), 0 === (i = n(e)).length) return this;
            for (r(), o = document.querySelectorAll("[id]"), a = [].map.call(o, function (e) {
                return e.id
            }), l = 0; l < i.length; l++) if (this.hasAnchorJSLink(i[l])) p.push(l); else {
                if (i[l].hasAttribute("id")) s = i[l].getAttribute("id"); else if (i[l].hasAttribute("data-anchor-id")) s = i[l].getAttribute("data-anchor-id"); else {
...
!function (e) {
    ...
    return function e(t, n, r) {
        ...
        1: [function (e, t, n) {
            ...
            !function (i, o) {
                if ("function" == typeof e && e.amd) e(["module", "select"], o); else if (void 0 !== r) o(n, t("select")); else {
                    var a = {exports: {}};
            ...
            !function (i, o) {
                if ("function" == typeof e && e.amd) e(["module", "./clipboard-action", "tiny-emitter", "good-listener"], o); else if (void 0 !== r) o(n, t("./clipboard-action"), t("tiny-emitter"), t("good-listener")); else {
                    var a = {exports: {}};
...
!function (e) {
    if (e.document) {
        ...
        t.querySelectorAll || (t.querySelectorAll = function (n) {
            ...
            e.atob = e.atob || function (e) {
                ...
                for (; c < e.length;) n = e.charCodeAt(c++), r = e.charCodeAt(c++), i = e.charCodeAt(c++), o = n >> 2, a = (3 & n) << 4 | r >> 4, s = (15 & r) << 2 | i >> 6, l = 63 & i, c === e.length + 2 ? (s = 64, l = 64) : c === e.length + 1 && (l = 64), u.push(t.charAt(o), t.charAt(a), t.charAt(s), t.charAt(l));
                return u.join("")
            }
    ...
    return function (e) {
        ...
        (function (t) {
            ...
            function i(e, t) {
                var n = {theme: k(M.settings.themes.gray, null), stylesheets: t.stylesheets, instanceOptions: t},
                    r = e.indexOf("?"), i = [e];
            ...
            function o(e) {
                ...
                if (null != r.text && (s.text = r.text, "object" === n.nodeName.toLowerCase())) {
                    for (var f = s.text.split("\\n"), A = 0; A < f.length; A++) f[A] = y.encodeHtmlEntity(f[A]);
                    s.text = f.join("\\n")
                }
                if (s.text) {
                ...
                if (r.font && (s.font = r.font, !m.noFontFallback && "img" === n.nodeName.toLowerCase() && M.setup.supportsCanvas && "svg" === m.renderer && (m = k(m, {renderer: "canvas"}))), r.font && "canvas" == m.renderer && (m.reRender = !0), "background" == t) null == n.getAttribute("data-background-src") && w.setAttr(n, {"data-background-src": g}); else {
                    var v = {};
                ...
                r.theme = s, n.holderData = {
                    flags: r,
                    engineSettings: m
                }, "image" != t && "fluid" != t || w.setAttr(n, {alt: s.text ? d ? s.text : s.text + " [" + l + "]" : l});
            ...
            function a(e) {
                ...
                "background" == i ? (o.style.backgroundImage = "url(" + r + ")", l.noBackgroundSize || (o.style.backgroundSize = c.width + "px " + c.height + "px")) : ("img" === o.nodeName.toLowerCase() ? w.setAttr(o, {src: r}) : "object" === o.nodeName.toLowerCase() && w.setAttr(o, {
                    data: r,
                    type: "image/svg+xml"
                }), l.reRender && t.setTimeout(function () {
                    var e = n();
                    if (null == e) throw"Holder: couldn't render placeholder";
                    "img" === o.nodeName.toLowerCase() ? w.setAttr(o, {src: e}) : "object" === o.nodeName.toLowerCase() && w.setAttr(o, {
                        data: e,
                        type: "image/svg+xml"
                    })
            ...
            function s(e) {
                ...
                var r = e.flags.lineWrap || M.setup.lineWrapRatio, i = e.width * r, o = i,
                    a = new v({width: e.width, height: e.height}), s = a.Shape,
                ...
                if (c.resize(e.width, e.height), a.root.add(c), e.flags.outline) {
                    ...
                    u = u.lighten(u.lighterThan("7f7f7f") ? -.1 : .1), c.properties.outline = {
                        fill: u.toHex(!0),
                        width: 2
                    }
                }
                ...
                if (g.lineCount > 1) {
                    ...
                    if (t(p, y, w, p.properties.leading), p.add(y), "left" === e.align) p.moveTo(e.width - i, null, null); else if ("right" === e.align) {
                        for (b in p.children) y = p.children[b], y.moveTo(e.width - y.width, null, null);
                        p.moveTo(0 - (e.width - i), null, null)
                    } else {
                        for (b in p.children) y = p.children[b], y.moveTo((p.width - y.width) / 2, null, null);
                        p.moveTo((e.width - p.width) / 2, null, null)
                    }
                    p.moveTo(null, (e.height - p.height) / 2, null), (e.height - p.height) / 2 < 0 && p.moveTo(null, 0, null)
                } else m = new s.Text(e.text), y = new s.Group("line0"), y.add(m), p.add(y), "left" === e.align ? p.moveTo(e.width - i, null, null) : "right" === e.align ? p.moveTo(0 - (e.width - i), null, null) : p.moveTo((e.width - g.boundingBox.width) / 2, null, null), p.moveTo(null, (e.height - g.boundingBox.height) / 2, null);
                return a
            }
            ...
            var g = n(2), m = n(3), v = n(6), y = n(7), b = n(8), w = n(9), x = n(10), E = n(11), S = n(12), C = n(15),
                k = y.extend, T = y.dimensionCheck, j = E.svg_ns, O = {
                    version: E.version, addTheme: function (e, t) {
                        ...
                        var s = w.getNodeArray(a.images), l = w.getNodeArray(a.bgnodes), c = w.getNodeArray(a.stylenodes),
                        ...
                        return n.stylesheets = [], n.svgXMLStylesheet = !0, n.noFontFallback = !!a.noFontFallback, n.noBackgroundSize = !!a.noBackgroundSize, c.forEach(function (e) {
                            ...
                            if (t.getComputedStyle) {
                                var r = t.getComputedStyle(e, null).getPropertyValue("background-image"),
                                    s = e.getAttribute("data-background-src"), l = s || r, c = null, u = a.domain + "/",
                                    h = l.indexOf(u);
                                if (0 === h) c = l; else if (1 === h && "?" === l[0]) c = l.slice(1); else {
                                    var d = l.substr(h).match(/([^\"]*)"?\)/);
                                    if (null !== d) c = d[1]; else if (0 === l.indexOf("url(")) throw"Holder: unable to parse background URL: " + l
                                }
                                if (c) {
                                    var f = i(c, a);
                            ...
                            var i = null != t.src, o = null != t.dataSrc && 0 === t.dataSrc.indexOf(a.domain),
                    ...
                    return function (r) {
                        ...
                        if (M.setup.supportsSVG) {
                            ...
                            var c = t.getBBox(), u = Math.ceil(c.width / i.properties.width), h = l.text.split(" "),
                                d = l.text.match(/\\n/g);
                            u += null == d ? 0 : d.length, n.nodeValue = l.text.replace(/[ ]+/g, "");
                            var f = t.getComputedTextLength(), A = c.width - f,
                                p = Math.round(A / Math.max(1, h.length - 1)), g = [];
                            if (u > 1) {
                                n.nodeValue = "";
                                for (var m = 0; m < h.length; m++) if (0 !== h[m].length) {
            ...
            for (var D in M.flags) M.flags.hasOwnProperty(D) && (M.flags[D].match = function (e) {
        ...
        function n(e) {
            ...
            var a = e.document, s = a.documentElement, l = "load", c = !1, u = "on" + l, h = "complete",
                d = "readyState", f = "attachEvent", A = "detachEvent", p = "addEventListener", g = "DOMContentLoaded",
                m = "onreadystatechange", v = "removeEventListener", y = p in a, b = c, w = c, x = [];
            if (a[d] === h) i(t); else if (y) a[p](g, n, c), e[p](l, n, c); else {
                a[f](m, n), e[f](u, n);
                try {
        ...
        t.parse = function (e) {
            ...
            for (var t = {}, n = e.split("&"), r = 0; r < n.length; r++) {
                ...
                if (a = s.exec(d)) t[a[1]] = t[a[1]] || [], t[a[1]][a[2]] = i(h[1]); else if (a = l.test(d)) {
                    for (a = d.split("."), c = t; a.length;) if (u = a.shift(), u.length) {
                        if (c[u]) {
        ...
        (function (e) {
            ...
            t.initSVG = function (e, t, n) {
                ...
                for (var c = 0; c < e.childNodes.length; c++) e.childNodes[c].nodeType === o && e.removeChild(e.childNodes[c]);
        ...
        var a = n(13), s = n(8), l = n(11), c = n(7), u = l.svg_ns, h = {
            element: function (e) {
        ...
        e.exports = function (e, t) {
            ...
            Object.keys(A.children).forEach(function (e) {
                ...
                Object.keys(t.children).forEach(function (e) {
                    var n = t.children[e], r = A.x + t.x + n.x, i = A.y + t.y + n.y,
                        o = h.element({tag: "text", content: n.properties.text, x: r, y: i});
                    g.push(o)
                })
            });
            ...
            var x = h.element({tag: "g", id: d, content: w}),
                E = h.element({tag: "style", content: p, type: "text/css"}), S = h.element({tag: "defs", content: E}),
                C = h.element({
                    tag: "svg",
                    content: [S, x],
        ...
        e.exports = function e(t, n, r) {
            ...
            function i(e) {
                var t = e.match(/^[\w-]+/), n = {tag: t ? t[0] : "div", attr: {}, children: []},
            ...
            for (; d < t.length; d++) {
                ...
                if (void 0 !== t[d] && t[d] !== !0) if ("string" == typeof t[d]) f && (t[d] = s(t[d])), t[0].children.push(t[d]); else if ("number" == typeof t[d]) t[0].children.push(t[d]); else if (Array.isArray(t[d])) {
                ...
                } else if ("function" == typeof t[d]) u = t[d]; else {
                    if ("object" != typeof t[d]) throw new TypeError('"' + t[d] + '" is not allowed as a value.');
                    for (c in t[d]) t[d].hasOwnProperty(c) && null !== t[d][c] && t[d][c] !== !1 && ("style" === c && "object" == typeof t[d][c] ? t[0].attr[c] = JSON.stringify(t[d][c], o).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'") : t[0].attr[c] = t[d][c])
                }
            }
            if (t[0] !== !1) {
                l = "<" + t[0].tag;
                for (h in t[0].attr) t[0].attr.hasOwnProperty(h) && (l += " " + h + '="' + a(t[0].attr[h]) + '"');
            ...
            return function (n) {
                ...
                for (var d in h.children) {
                    ...
                    for (var A in f.children) {
                        var p = f.children[A], g = r * (h.x + f.x + p.x),
