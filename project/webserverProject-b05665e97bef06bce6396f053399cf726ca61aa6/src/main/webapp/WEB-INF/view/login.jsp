...
<%@ page import="com.webserver.project.vo.Account" %>
                ...
                <div class="card-body">
                    <form action='/loginProcess' method='POST'>
                        <div class="form-group">
                             아이디<input type="text" class="form-control" id="username" name="username" placeholder="ID">
                        </div>
                        <div class="form-group">
                            패스워드 <input type="password" class="form-control" id="password" name="password" placeholder="Password">
                        </div>
                        <div class="checkbox">
                        ...
                        출처: https://to-dy.tistory.com/81?category=720806 [todyDev]
